...
const PairProgrammingPage = () => {
  ...
  return (
    <>
      <CssBaseline />
      <KnowledgePageLayout title={<PairPrgTitle />} index={<PairPrgNav value={value} handleChange={handleChange} pairProgrammingInfo={pairProgrammingInfo} />} body={<PairPrgBody
