...
cohortSchema.pre("findByIdAndUpdate", filterDeletedItems);
cohortSchema.plugin(mongooseHidden);

const addUsers = async function (cohort, updates) {
 // console.log(this, "FROM addusers")
 // const update = this.getUpdate();
console.log(updates, "=======FROM DATA in ADDUSERS======")
  //if ("students" in update) {
...
// console.log(this, "FROM SAVE")
//   this.updateUsers()
// });

cohortSchema.methods.updateUsers = function (data) {
  //console.log(data, "FROM method UPDATEUSERS")
  return addUsers(this, data);
};

cohortSchema.pre("find", addUsers);
cohortSchema.pre("findOne", addUsers);
cohortSchema.pre("findByIdAndUpdate", addUsers);
